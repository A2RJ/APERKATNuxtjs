    ...
    <div style="font-family: 'Poppins', sans-serif">
      <div class="list-footer-footer-2-2">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <h2
              class="footer-text-title-footer-2-2 list-space-footer-2-2-title"
            >
              Product
            </h2>
            <nav style="list-style-type: none">
      ...
      <div class="border-color-footer-2-2 info-footer-footer-2-2">
        ...
        >
          <div
            class="d-flex title-font font-medium align-items-center"
            style="cursor: pointer"
          >
            <svg
              class="social-media-c-footer-2-2 social-media-left-footer-2-2"
              width="30"
              height="30"
              viewBox="0 0 30 30"
              fill="none"
            ...
            <svg
              class="social-media-c-footer-2-2 social-media-center-1-footer-2-2"
              width="30"
              height="30"
              viewBox="0 0 30 30"
              fill="none"
            ...
            <svg
              class="social-media-p-footer-2-2 social-media-center-2-footer-2-2"
              width="30"
              height="30"
              viewBox="0 0 30 30"
              fill="none"
            ...
            <svg
              class="social-media-c-footer-2-2 social-media-right"
              width="30"
              height="30"
              viewBox="0 0 30 30"
              fill="none"
          ...
          >
            <a class="footer-link-footer-2-2" style="text-decoration: none"
              >Terms of Service</a
            >
