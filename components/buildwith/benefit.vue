<template>
  <section style="height:100%; width: 100%; box-sizing: border-box; background-color: #FFFFFF">
          ...
          <div class="text-center title-text-content-2-2">
            ...
            <p class="text-caption-content-2-2" style="  margin-left: 3rem; margin-right: 3rem;">Lakukan dengan hati, luapkan dengan ekspresi <br> Universitas Teknologi Sumbawa</p>
          </div>
