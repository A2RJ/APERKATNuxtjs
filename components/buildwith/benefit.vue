  ...
  >
    <div style="font-family: 'Poppins', sans-serif">
      <div class="text-center title-text-content-2-2">
        <h1 class="text-title-content-2-2">APERKAT</h1>
        <p
          class="text-caption-content-2-2"
          style="margin-left: 3rem; margin-right: 3rem"
        >
          Lakukan dengan hati, luapkan dengan ekspresi <br />
      ...
      <div class="grid-padding-content-2-2 text-center">
        <div class="row">
          <div class="col-lg-4 column-content-2-2">
            ...
            <p class="icon-content-2-2-caption">
      ...
      <div class="card-block-content-2-2">
        <div class="card-content-2-2">
          <div class="d-flex flex-lg-row flex-column align-items-center">
            ...
            <div
              class="flex-grow-1 text-lg-start text-center card-text-content-2-2"
            >
              <h3 class="card-content-2-2-title">
                Fast Business Management in 30 minutes
              </h3>
              <p class="d-none d-lg-block card-content-2-2-caption">
                Our tools for business analysis helps an organization
                understand<br />
                market or business development.
              </p>
              <p class="d-block d-lg-none card-content-2-2-caption">
